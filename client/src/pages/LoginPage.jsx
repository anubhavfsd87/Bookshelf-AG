    ...
    <div className="mt-7 flex grow items-center justify-around p-4 mr-1">
      <div className="mb-64 mt-74 mr-9 p-9 bg-lightblack rounded-3xl mt-3 py-7">
        ...
        <form className="max-w-md mx-auto mt-2 ml-4 bg-lightblack" onSubmit={handleLoginSubmit}>
          ...
          <button className="primary mt-3 text-2xl">Sign in</button>
          ...
          />  
          < br/>
          <Link href="/" className="flex gap-2 items-center justify-center p-4 border-b border-b-gray-100 bg-black hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md hover:shadow-gray-300 transition-all hover:scale-110">
          ...
          <Link href="/" className="flex gap-4 items-center justify-center p-4 border-b border-b-gray-100 bg-black mt-4 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md hover:shadow-gray-300 transition-all hover:scale-110">
